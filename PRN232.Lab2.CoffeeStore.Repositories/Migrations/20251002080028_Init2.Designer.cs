...
namespace PRN232.Lab2.CoffeeStore.Repositories.Migrations
{
    ...
    [Migration("20251002080028_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Models.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Models.ProductInMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PRN232.Lab2.CoffeeStore.Repositories.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Models.Order", b =>
                {
                    b.HasOne("PRN232.Lab2.CoffeeStore.Repositories.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("PRN232.Lab2.CoffeeStore.Repositories.Models.ProductInMenu", b =>
                {
                    b.HasOne("PRN232.Lab2.CoffeeStore.Repositories.Models.Menu", "Menu")
